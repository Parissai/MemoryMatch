...
function reveal(cell) {
    cell.style.backgroundColor = 'red';  //color
    cell.innerHTML = cell.value;
    cell.clicked = true;
}

function hide(cell) {
    cell.style.backgroundColor = 'blue';  //color
    cell.innerHTML = "";
    cell.clicked = false;
}
...
function startTimer() {
    if (started == false) {
        interval = setInterval(function () { time++ , document.getElementById('timer').innerHTML = 'time passed: ' + time; }, 1000);
        started = true;
    }
}
